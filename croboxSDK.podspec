#
#  Be sure to run `pod spec lint croboxSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "idrisyildiz"
  # spec.authors            = { "idrisyildiz" => "idrisyildiz7@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/idrisyildiz"
